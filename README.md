...
<head>
    ...
    <!-- استبدل CDN Tailwind بملف محلي -->
    <script>
        // أضف محتوى Tailwind CSS هنا (تم تقصيره للاختصار)
        !function(){var e=document,t=e.createElement("link");t.rel="stylesheet",t.href="https://unpkg.com/tailwindcss@^3.0/dist/tailwind.min.css",e.head.appendChild(t)}();
    </script>
    <!-- استخدم نسخة مستقرة من Chart.js -->
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="org-chart">
                        ...
                        <div class="level">
                            <div class="children">
                                <div>
                                    <div class="children single-child">
